 ...
 * @author Casa
 */
public class AtualizarFrequencia4 extends javax.swing.JFrame {

    /**
     * Creates new form AtualizarFrequencia4
     */
    public AtualizarFrequencia4() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtualizarFrequencia4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() { 
                new AtualizarFrequencia4().setVisible(true);
            }
        });
    }
